...
; Date: 2015/7/17
; Time: 10:06
; 说明：使用PB2(PWM)的输出来触发PB1(Int)，使之进入中断，以便转态PB0口。
; =========================================================================
...
Main_Prog:
		...
		MOVIA		0x02			;; ENABLE PB_Int Interrupt
		MOVAR		INTE
...
F_IOInit:
		...
		MOVIA		00000010		;; Enable PB1 has Pin-Change Int Function
		MOVAR		BWUCON
...
;====================================================================
; Project Name: Time1/PWM1 初始化
; Madify Data: 2014.12.11
		MOVIA		00000000
		SFUN		T1CR1			;; Disale Timer1
		MOVIA		0xF7
		MOVIA		INTF			;; Clr Timer1 Flag
		MOVIA		0x20			;; PWM 频率：62.5K 
		SFUN		TMR1
		MOVIA		0x10			;; Duty 50%
		SFUN		PWM1DUTY
		MOVIA		0x00
