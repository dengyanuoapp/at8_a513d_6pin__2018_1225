...
; Date: 2014/12/14
; Time: 20:53
; 说名：此程序是选择 PB2 当 BZ 输出的 Demo Code
; =========================================================================
...
; Buzzer 频率= (1/I_HRC)*指令频率*分频
;			 = (1/4MHz)*4*128
;			 = 7.813KHz
		MOVIA		0X86			;; BZ1EN(B7):1:EN/0:Dis / B3~B0: BZ1 Frequecny Select
		SFUN		BZ1CR
		
		MOVIA		0x03			;; TIMER1(B0):1:EN/0:Dis, AUTO ReLoad(B1):1:En/0:Dis, PWM1oEN(B7):1:P6 is PWMO/0:P6 is GPIO
		SFUN		T1CR1
		RET
