...
;====================================================================
; Project Name: P2V Comparator 初始化
; Madify Data: 2016.02.25
F_P2VSet:
	;; Bit[3:0]:VS 设定P2V Mode的比对电压
	;; Bit[7:4]:PS 设定P2V Mode的输入IO
	;; PS 仿真版上的 VDD=5.0V
		MOVIA		00000100b		;; P2V Mode < V+ -> PA0 / V- -> 4/16 VDD
		IOST		CMPCR
